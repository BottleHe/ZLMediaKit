...
// jt1078 server 超时  [AUTO-TRANSLATED:a65573fd]
// JT1078 server timeout
extern const std::string kBroadcastJt1078ServerTimeout;
#define BroadcastJt1078ServerTimeoutArgs uint16_t &local_port, const MediaTuple &tuple
